...
export const stays: Stay[] = [
  ...
  {
    id: "stay_martinhal_quinta",
    slug: "martinhal-quinta",
    status: "published",
    feed: {
      externalId: "martinhal-quinta-demo",
      provider: "booking",
      name: "Martinhal Quinta",
      slug: "martinhal-quinta",
      destination: "Algarve",
      destinationSlug: "algarve",
      region: "Quinta do Lago",
      country: "Portugal",
      countryCode: "PT",
      propertyType: "villa",
      stars: 5,
      ...
      images: [
        { url: "/mallorca.jpg", alt: "Martinhal Quinta", role: "hero", provider: "manual", position: 1 },
        { url: "/mallorca.jpg", alt: "Familievilla in de Algarve", role: "gallery", provider: "manual", position: 2 },
      ],
      heroImage: "/mallorca.jpg",
      gallery: ["/mallorca.jpg", "/mallorca.jpg"],
      reviews: [{ provider: "booking", score: 8.8, scale: 10, normalizedScore: 8.8, count: 410, label: "Excellent", url: "https://www.booking.com" }],
      primaryReview: { provider: "booking", score: 8.8, scale: 10, normalizedScore: 8.8, count: 410, label: "Excellent", url: "https://www.booking.com" },
      reviewScore: 8.8,
      reviewCount: 410,
      reviewProvider: "booking",
      reviewLabel: "Excellent",
      ...
      currency: "EUR",
      affiliateUrl: "https://www.booking.com",
      providers: [{ provider: "booking", externalId: "martinhal-quinta-demo", affiliateUrl: "https://www.booking.com", deepLink: "https://www.booking.com", priceFrom: 360, currency: "EUR", available: true, priority: 1 }],
      amenities: [
        { key: "family_rooms", label: "Familievilla’s", category: "room", source: "feed" },
        { key: "kids_club", label: "Kidsclub", category: "family", source: "feed" },
        { key: "babysitting", label: "Babysitting", category: "family", source: "feed" },
        { key: "children_pool", label: "Kinderbad", category: "family", source: "feed" },
        { key: "restaurant", label: "Restaurant", category: "food", source: "feed" },
        { key: "kitchen", label: "Keuken", category: "room", source: "feed" },
      ],
      rooms: [
        {
          id: "martinhal-quinta-villa",
          name: "Family Villa",
          description: "Ruime villa met keuken en aparte slaapkamers, ideaal voor gezinnen die privacy en resortservice willen combineren.",
          maxGuests: 6,
          bedrooms: 3,
          bathrooms: 2,
          hasKitchen: true,
      ...
      rawAmenities: ["Familievilla’s", "Kidsclub", "Babysitting", "Kinderbad", "Restaurant", "Keuken"],
      rawRoomTypes: ["Family Villa"],
    },
    editorial: {
      label: "Villa Family Selectie",
      title: "Martinhal Quinta",
      subtitle: "Een luxe villa-resort in Quinta do Lago voor gezinnen die ruimte en service zoeken.",
      summary: "Martinhal Quinta is ideaal voor gezinnen die de vrijheid van een villa willen combineren met kindvriendelijke resortfaciliteiten.",
      whySelected: "We selecteren dit verblijf vanwege de villa-opzet, familiefaciliteiten en sterke ligging in de Algarve.",
      bestFor: ["Grote gezinnen", "Families met baby’s", "Luxe villa vakanties"],
      highlights: ["Familievilla’s", "Keuken", "Kidsclub", "Babysitting"],
      littleAtlasNotes: [
        "Sterk voor gezinnen die meer ruimte willen dan een hotelkamer.",
        "Ideaal voor families met jonge kinderen of meerdere generaties.",
        "Een auto is handig voor strand en restaurants.",
      ],
      nearby: ["Quinta do Lago", "Ria Formosa", "Vale do Lobo", "Faro"],
      faqs: [{ question: "Is Martinhal Quinta geschikt voor grote gezinnen?", answer: "Ja, vooral door de villa’s met meerdere slaapkamers en familievriendelijke voorzieningen." }],
      seoTitle: "Martinhal Quinta met kinderen | Little Atlas",
      seoDescription: "Bekijk Martinhal Quinta als luxe villa-resort voor gezinnen in de Algarve.",
      aiGenerated: false,
      reviewedByEditor: true,
    },
    familyAttributes: {
    ...
    familyScores: {
      babies: { score: 92, label: "excellent", reasons: ["Villa met keuken", "Babyvoorzieningen", "Babysitting"], source: "hybrid", confidence: 88 },
      toddlers: { score: 90, label: "excellent", reasons: ["Kinderbad", "Kidsclub", "Ruimte rondom de villa"], source: "hybrid", confidence: 86 },
      kids: { score: 84, label: "high", reasons: ["Kidsclub", "Zwembad", "Villa-opzet"], source: "hybrid", confidence: 82 },
      teens: { score: 78, label: "medium", reasons: ["Ruimte", "Algarve-activiteiten", "Auto aanbevolen"], source: "hybrid", confidence: 76 },
    },
    collectionMatches: [],
  },
  
  {
    ...
    feed: {
      ...
      images: [
        { url: "/mallorca.jpg", alt: "Daios Cove", role: "hero", provider: "manual", position: 1 },
        { url: "/mallorca.jpg", alt: "Luxe resort aan een baai op Kreta", role: "gallery", provider: "manual", position: 2 },
      ],
      heroImage: "/mallorca.jpg",
      gallery: ["/mallorca.jpg", "/mallorca.jpg"],
      reviews: [{ provider: "booking", score: 9.1, scale: 10, normalizedScore: 9.1, count: 520, label: "Excellent", url: "https://www.booking.com" }],
      primaryReview: { provider: "booking", score: 9.1, scale: 10, normalizedScore: 9.1, count: 520, label: "Excellent", url: "https://www.booking.com" },
      reviewScore: 9.1,
      reviewCount: 520,
      reviewProvider: "booking",
      reviewLabel: "Excellent",
      ...
      currency: "EUR",
      affiliateUrl: "https://www.booking.com",
      providers: [{ provider: "booking", externalId: "daios-cove-demo", affiliateUrl: "https://www.booking.com", deepLink: "https://www.booking.com", priceFrom: 480, currency: "EUR", available: true, priority: 1 }],
      amenities: [
        { key: "kids_club", label: "Kidsclub", category: "family", source: "feed" },
        { key: "children_pool", label: "Kinderbad", category: "family", source: "feed" },
        { key: "near_beach", label: "Privébaai", category: "beach", source: "feed" },
        { key: "spa", label: "Spa", category: "wellness", source: "feed" },
        { key: "restaurants", label: "Restaurants", category: "food", source: "feed" },
        { key: "fitness", label: "Fitness", category: "sports", source: "feed" },
      ],
      rooms: [
        {
          id: "daios-family-suite",
          name: "Family Suite",
          description: "Ruime suite met premium uitstraling, geschikt voor gezinnen die luxe en rust zoeken.",
          maxGuests: 4,
          bedrooms: 1,
          bathrooms: 1,
          hasSeparateBedroom: true,
      ...
      rawAmenities: ["Kidsclub", "Kinderbad", "Privébaai", "Spa", "Restaurants", "Fitness"],
      rawRoomTypes: ["Family Suite"],
    },
    editorial: {
      label: "Luxury Cove Selectie",
      title: "Daios Cove",
      subtitle: "Een luxe resort aan een beschutte baai op Kreta.",
      summary: "Daios Cove combineert een spectaculaire ligging aan zee met premium service en voldoende comfort voor gezinnen.",
      whySelected: "We selecteren dit verblijf vanwege de luxe uitstraling, beschutte baai, familiesuites en sterke reviewscore.",
      bestFor: ["Luxe gezinnen", "Families met schoolgaande kinderen", "Ouders die strand en comfort zoeken"],
      highlights: ["Beschutte baai", "Kidsclub", "Familiesuites", "Hoge reviewscore"],
      littleAtlasNotes: [
        "Sterk voor gezinnen die luxe en strand willen combineren.",
        "Door de ligging is een auto handig voor uitstapjes.",
        "Meer premium resort dan uitgesproken kinderhotel.",
      ],
      nearby: ["Agios Nikolaos", "Elounda", "Spinalonga", "Kretenzische baaien"],
      faqs: [{ question: "Is Daios Cove geschikt voor kinderen?", answer: "Ja, vooral voor gezinnen die luxe, strand en resortcomfort zoeken." }],
      seoTitle: "Daios Cove met kinderen | Little Atlas",
      seoDescription: "Bekijk Daios Cove als luxe familieverblijf op Kreta.",
      aiGenerated: false,
      reviewedByEditor: true,
    },
    familyAttributes: {
    ...
    familyScores: {
      babies: { score: 82, label: "high", reasons: ["Babyvoorzieningen", "Rustige baai", "Familiesuites"], source: "hybrid", confidence: 80 },
      toddlers: { score: 80, label: "high", reasons: ["Kinderbad", "Kidsclub", "Beschutte ligging"], source: "hybrid", confidence: 80 },
      kids: { score: 86, label: "high", reasons: ["Kidsclub", "Strand", "Zwembaden"], source: "hybrid", confidence: 84 },
      teens: { score: 84, label: "high", reasons: ["Strand", "Fitness", "Uitstapjes rond Agios Nikolaos"], source: "hybrid", confidence: 82 },
    },
    collectionMatches: [],
  },
